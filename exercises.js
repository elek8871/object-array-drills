...
let albumNum = talkingHeadsAlbums
if (albumNum.length >= 6) {
...
let albumAmt= albumNum.length
 if (albumAmt %2 == 0){
   console.log (`The number ${albumAmt} is odd`)
 } else {
   console.log (`The number ${albumAmt} is odd`)
 }
...
if (albumAmt %2 == 0 ){
  console.log (`The number ${albumAmt} is divisible by 2`)
} else if (albumAmt %3 == 0){
  console.log (`The number ${albumAmt} is divisible by 3`)
} else if (albumAmt %2 == 0 && albumAmt %3 == 0){
  console.log (`The number ${albumAmt} is divisible by 2 and 3`)
} else if ((albumAmt %2 == 0 || albumAmt %3 == 0)) {
  console.log (`The number ${albumAmt} is divisible by 2 or 3`)
} else{
  console.log ("check your code Elek")
}
